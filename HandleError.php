...
class HandleError
{
	...
	public function sendErroAdmin($dest, $rem, $assunto, $cc = false, $msg = '')
	{
		...
		if (!mail($dest, $assunto, $html, $headers, '-r' . $dest)) { // Se for Postfix
			$headers .= 'Return-Path: ' . $dest . $quebra_linha; // Se "n�o for Postfix"
	...
	/**
	 * Prepara o redirecionamento para a Home do site, caso j� n�o esteja l�
	 */
